...
async execute(interaction , client) {
    ...
    if(interaction.guild.id === mainguild){
        embed.setImage(`https://i.postimg.cc/0N0gL2FJ/20250102-233828.png`);
...
- - ___السعر___ : \`700\` عملة اسبوعيا **`)
                            ...
                            if(interaction.guild.id === mainguild){
                                embed2.setImage(`https://i.postimg.cc/26t0tskZ/A1-D4-D0-E9-4-D5-E-462-A-BD08-4-D58-AC2-E76-E4.jpg`);
