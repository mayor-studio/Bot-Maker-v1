...
async execute(interaction) {
    ...
    let roleCheck = roles.find((r) => r.roleId == role.id)
    if(roleCheck) return interaction.reply(`**هذه الرتبة موجودة بالفعل في قائمة البيع**`)
