...
module.exports = {
    ...
    .addIntegerOption(Option => Option
        .setName(`openhour`)
        .setDescription(`ساعة فتح الرومات (توقيت مصر)`)
        .setRequired(false))
        .addIntegerOption(Option => Option
            .setName(`openminute`)
            .setDescription(`دقيقة فتح الرومات (توقيت مصر)`)
            .setRequired(false))
            .addIntegerOption(Option => Option
                .setName(`closehour`)
                .setDescription(`ساعة غلق الرومات (توقيت مصر)`)
                .setRequired(false))
                .addIntegerOption(Option => Option
                    .setName(`closeminute`)
                    .setDescription(`دقيقة غلق الرومات (توقيت مصر)`)
                    .setRequired(false))
